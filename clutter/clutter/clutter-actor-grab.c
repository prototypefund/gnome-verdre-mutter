              ...
              ClutterCrossingMode      mode)
{
  ...
  clutter_emit_crossing_event (device, sequence, old_actor, new_actor, topmost_actor, bottommost_actor, mode);

  CLUTTER_GRAB_CLASS (clutter_actor_grab_parent_class)->focus_event (grab,
               device, sequence, old_actor, new_actor, mode);
}

static void
key_event (ClutterActorGrab *grab,
...
static void
motion_event (ClutterActorGrab *grab,
                const ClutterEvent     *event)
{
  ClutterActorGrabPrivate *priv =
    clutter_actor_grab_get_instance_private (grab);
...
static void
button_event (ClutterActorGrab *grab,
                const ClutterEvent     *event)
{
  ClutterActorGrabPrivate *priv =
    clutter_actor_grab_get_instance_private (grab);
...
static void
scroll_event (ClutterActorGrab *grab,
                const ClutterEvent     *event)
{
  ClutterActorGrabPrivate *priv =
    clutter_actor_grab_get_instance_private (grab);
...
static void
touch_event (ClutterActorGrab *grab,
             const ClutterEvent     *event)
{
  ClutterActorGrabPrivate *priv =
    clutter_actor_grab_get_instance_private (grab);
...
static void
pad_event (ClutterActorGrab *grab,
             const ClutterEvent     *event)
{
  ClutterActorGrabPrivate *priv =
    clutter_actor_grab_get_instance_private (grab);
