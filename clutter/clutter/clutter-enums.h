...
typedef enum
{
  CLUTTER_CROSSING_NORMAL,
CLUTTER_CROSSING_GRAB,
CLUTTER_CROSSING_UNGRAB,
CLUTTER_CROSSING_ACTOR_CHANGED,
CLUTTER_CROSSING_DEVICE_ADDED,
CLUTTER_CROSSING_DEVICE_REMOVED
} ClutterCrossingMode;
