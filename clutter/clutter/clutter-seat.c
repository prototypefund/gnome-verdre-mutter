 ...
 *
 * Returns: (transfer none) (element-type Clutter.InputDevice): A list
 *   of #ClutterInputDevice. The returned list and its elements are owned by
 *   Clutter and may not be freed.
 **/
const GList *
